...
from src.mlproject.exception import CustomException  # Add the import for CustomException
...
def read_yaml(path_to_yaml: Path) -> ConfigBox:
    ...
    Raises:
        CustomException: If yaml file is empty or encounters any other exception.
    ...
    try:
        ...
        raise CustomException(str(e), None)
